...
function App () {
  ...
  var visa = document.getElementById("visaimg");
    if (cardNumber.indexOf("123") > -1){ 
                    ...
                    <div className="flex-container">
                      <input className="labels" name="cardnumber" id="cardnumber" type="text" placeholder="Número de tarjeta" onChange={ (event) =>showOptions(event)} />
                        <div className= "cardsplace">
                          <img src="visa.jpg" alt="Visa-card" id="visaimg" />
                          <img src="cardplace.png" alt="card-place" id="cardplace" />
                        </div> 
                    </div>
